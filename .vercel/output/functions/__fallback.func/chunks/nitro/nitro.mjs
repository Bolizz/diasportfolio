...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "28d23e12-3d5b-43f9-b08b-4bc45f64f1f6",
...
const _lazy_Q3aX4b = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_Q3aX4b, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Q3aX4b, lazy: true, middleware: false, method: undefined }
];
